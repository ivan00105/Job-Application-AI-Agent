...
4. Set project name: `job-agent` (or your choice)
...
2. Click **"New Query"**
3. Copy the contents of `supabase/migrations/20251005111019_create_initial_schema.sql`
4. Paste into SQL editor and click **"Run"**
5. Do the same for `supabase/migrations/20251005144633_create_interview_preparation_schema.sql`
...
**Important Notes:**
- Replace `SUPABASE_URL` and `SUPABASE_KEY` with your actual values from Step 2
...
The frontend `.env` should already exist at project root. Verify it has:
...
**Update these with your actual Supabase credentials from Part 1.**
...
│   ├── 20251005111019_create_initial_schema.sql
│   └── 20251005144633_create_interview_preparation_schema.sql ⭐
│
...
- [ ] Applied interview prep migration
